...
public class PersonalDataPage extends BasePage {
    ...
    public PersonalDataPage(final WebDriver driver) {
        super(driver);
    }
    ...
    public PersonalDataPage changePersonalData() {
        click(EDIT_PERSONAL_DATA_BTN);
        return new PersonalDataPage(driver);
    }

    public PersonalDataPage typeName(final String name) {
        type(NAME_FIELD, name);
        return new PersonalDataPage(driver);
    }

    public PersonalDataPage typeSurname(final String surname) {
        type(SURNAME_FIELD, surname);
        return new PersonalDataPage(driver);
    }

    public PersonalDataPage typeLocation(final String location) {
